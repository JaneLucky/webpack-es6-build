...
import {
	RenderPass
} from '@/three/postprocessing/RenderPass.js';
import {
	ShaderPass
} from '@/three/postprocessing/ShaderPass.js';
import {
	SMAAPass
} from '@/three/postprocessing/SMAAPass.js';

import {
	BSCShader
} from '@/three/shaders/BSCShader.js';
import {
	FXAAShader
} from '@/three/shaders/FXAAShader.js';
import {
	SMAAShader
} from '@/three/shaders/SMAAShader.js';
//设置后期
